...
\\\\
It seems that individuall 
 preprocessing technique that yields best results is stemming, though lowercasing and merging of Czech variants give the most consistent results. To ensure the consistency of these findings, same test was repeated for the word--level document size. Results are given in the table below.  
\begin{table}[h!]
\begin{tabular}{ l | c c | c c | c c | c}
...
Evaluation of preprocessing technique on word level document size gives approximatively similar results, though it can be observed that merging of czech variants gives slighty better results in this case. Lowercasing filtering of czech stop words is not that far behind. In the next round of experiments, combinations of best individual techiques were tested to find out whether an improvement is obtained. 
...
STOP+LOWCASE  & 90.6 & 100 & 92.31 & 100 & 91.45 & 100 & 13.96\\
 ...
 STOP+MERGE  & 92.31 & 100 & 93.16 & 100 & 93.16 & 100 & 13.96 \\
STEM+STOP+LOWCASE  & 91.45 & 100 & 93.16 & 100 & 92.31 & 100 & 13.96 \\
STEM+STOP+MERGE  & 91.45 & 100 & 93.16 & 100 & 92.31 & 100 & 13.96 \\
STOP+MERGE+LOWCASE  & 90.6 & 100 & 92.31 & 100 & 91.45 & 100 & 13.96 \\
STEM+STOP+& 91.45 & 100 & 93.16 & 100 & 92.31 & 100 & 13.96 \\
+MERGE+LOWCASE  &&&&&&&\\
\end{tabular}
...
It seems that the combination of filters reduces the word space too much, which causes the overal precision to deteriorate a bit. It is also interesting to see that application of combination of 3 techniques yields slightly better results than the application of just 2 techniques. If we look at the last column, where all 4 preprocessing techniques were tested, we can see that results are the same as for the combinations of 3 techniques which do not include merge of czech variants. It would seem that this technique does not contribute any improvement when in combination with other preprocessing techniques. 
